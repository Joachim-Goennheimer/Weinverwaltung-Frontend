...
// later forEachloop over Array
        for(let i = 0; i < 10; i++) {
            ...
            $("#winzerTableBody").append(
                createWinzerTableEntry(currentWinzer)
            )
        }
...
function createWinzerTableEntry(winzerObject) {
    ...
    let tableEntryHTML = '<tr>'
                            +'<td>'+ winzerObject.id +'</td>'
                            +'<td>'+ winzerObject.name +'</td>'
                            +'<td>'+ winzerObject.vorname +'</td>'
                            +'<td>'+ winzerObject.email +'</td>'
                            +'<td>'+ winzerObject.telefon +'</td>'
                            +'<td data-toggle="modal" data-target="#winzerDetailsModalCenter" onclick="loadDetailsIntoModal('+ winzerObject.id+ ')"><i class="fas fa-info"></i></td>'
                        '</tr>';
